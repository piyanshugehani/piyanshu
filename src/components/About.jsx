...
const About = () => {
  return (
    <>
      ...
      >
        A passionate software developer with experience in full-stack web development. I specialize in building dynamic and responsive applications using modern technologies like React/Next, JavaScript/TypeScript, Python, and more. Apart from this, I enjoy solving complex problems, learning new tools, and continuously growing my skills. My goal is to create impactful solutions that improve user experiences and make a positive difference in the tech space.
      </motion.p>
  ...
  <a
    ...
    className="w-8 h-8 hover:-translate-y-2 ease-in transition-all duration-100 cursor-pointer"
  >
    <svg xmlns="http://www.w3.org/2000/svg" width="100%" height="100%" viewBox="0 0 72 72" id="linkedin"><g fill="none" fill-rule="evenodd"><g><rect width="72" height="72" fill="#117EB8" rx="4"></rect><path fill="#FFF" d="M13.139 27.848h9.623V58.81h-9.623V27.848zm4.813-15.391c3.077 0 5.577 2.5 5.577 5.577 0 3.08-2.5 5.581-5.577 5.581a5.58 5.58 0 1 1 0-11.158zm10.846 15.39h9.23v4.231h.128c1.285-2.434 4.424-5 9.105-5 9.744 0 11.544 6.413 11.544 14.75V58.81h-9.617V43.753c0-3.59-.066-8.209-5-8.209-5.007 0-5.776 3.911-5.776 7.95V58.81h-9.615V27.848z"></path></g></g></svg>
  </a>
  <a
